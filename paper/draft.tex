...
\begin{figure}[H]
    \centering
    \includegraphics[width = 6cm, height = 6cm]{figures/partisanship/plot_partisanship_by_cbo_group.pdf}
    \includegraphics[width = 6cm, height = 6cm]{figures/partisanship/plot_partisanship_by_contract_type.pdf}
